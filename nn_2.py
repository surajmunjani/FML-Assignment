...
def main():
    ...
    df = pd.DataFrame({
        'Name': ['max_epochs','learning_rate', 'batch_size', 'num_layers', 'num_units', 'regularization_parameter'],
        'Value': [max_epochs,learning_rate, batch_size, num_layers, num_units, lamda]
    })
